...
<%response.setHeader("Cache-Control","no-cache");
	...
	<div class="container">
		<div class="">
			...
			<form:form id="branchAdminAdd" method="post" action="branchAdminSave"
				commandName="branchAdminAdd" >
				<div style="padding-top: 75px"></div>
				<div class="row row-style">
					<div class="col-sm-6 col-md-6">
						<%-- <tr>
        <td><form:label path="branch_admin_id">Branch Admin Id:<span class="required" style="color:red">*</span></form:label></td>
        <td><form:input path="branch_admin_id" pattern="[A-Za-z]{1,10}" title="Enter only characters(maximum size = 10)" placeholder="Enter Id" required="true"/></td>
    </tr> --%>
						...
						<div class="form-group">
							...
							<form:select path="gender" class="form-control">
								<form:option value=" " class="form-control"></form:option>
				...
				<form:option value="Female" class="form-control">Female</form:option>&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<div class="form-group">
							...
							<form:input type="text" path="address1" name="address1"
								class="form-control" placefolder="Enter Address"
								autocomplete="off" />
						</div>
					...
					<div class="col-sm-6 col-md-6">
						...
						<div class="form-group">
							...
							<form:input type="text" path="alt_contact" class="form-control"
								name="alt_contact" placeholder="Enter Alternate Contact"
								autocomplete="off" />
						</div>
				...
				<div class="col-sm-6 col-md-6">
					<input type="submit" class="btn btn-add" style="border-radius: 22px;color:white;" value="Add Branch Admin" />
				</div>
			</div>
			</form:form>
</div>
