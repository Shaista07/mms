...
<nav
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<div class="row">
					<div class="col-sm-3">
						<li class="nav-item"><a class="nav-link" href="/mms/medicine"   style="border-bottom: 2px solid #e67e22;">
			...
			<form class="form-inline my-2 my-lg-0"><a class="btn btn-ghost"
					href="logout">Logout</a></form>
		</div>
	</nav> 
	<div class="container">
		<div class="">
		<c:url var="updateAction" value="medicineUpdate"></c:url>
		<form:form id="medicineEdit" method="post" action="${updateAction }" commandName="medicineEdit" onsubmit="myFunction()">
				...
				<div class="row row-style">
        			...
        			<form:input type="text" path="medicine_id" name="medicine_id" class="form-control" value="${medicine.medicine_id}" readonly="true" autocomplete="off" placeholder="Enter Name" />
					</div>
    				
    				<div class="form-group">
    				<form:label path="medicine_descrip">Name :<span class="required" style="color:red">*</span></form:label>
        			<form:input type="text" path="medicine_descrip" name="medicine_descrip" value="${medicine.medicine_descrip}" class="form-control" autocomplete="off" placeholder="Enter Name" />
					</div>
					
					<div class="form-group">
    				<form:label path="manufacturing">Manufacturing :<span class="required" style="color:red">*</span></form:label>
        			<form:input type="text" path="manufacturing" name="manufacturing" value="${medicine.manufacturing}" class="form-control" autocomplete="off" placeholder="Manufacturing company" />
					</div>
    				
    				<div class="form-group">
    				<form:label path="dosage">Dosage :<span class="required" style="color:red">*</span></form:label>
        			<form:input type="text" path="dosage" name="dosage" class="form-control" value="${medicine.dosage}" autocomplete="off" placeholder="Enter First Name" />
					</div>
        			...
        			<form:input type="text" path="quantity" name="quantity" class="form-control" value="${medicine.quantity}" readonly="true" autocomplete="off" placeholder="Enter Quantity" />
    				</div>
					
					<div class="form-group">
        			<form:label path="cure">Cure:<span class="required" style="color:red">*</span></form:label>
        			<form:input type="text" path="cure" name="cure" class="form-control" value="${medicine.cure}" autocomplete="off" placeholder="Enter Cure for" />
   					</div>
					
   					<div class="form-group">
   					<form:label path="prescribed_for">Prescribed For:<span class="required" style="color:red">*</span></form:label>
        			<form:input type="text" path="prescribed_for" name="prescribed_for" value="${medicine.prescribed_for}" class="form-control" autocomplete="off" placeholder="A-adult/C-Children"/>
   					</div>
   					</div>
   					<div class="col-sm-5 col-md-5">
				</div>
				<div class="col-sm-6 col-md-6">
				<input type="submit" class="btn btn-add btn-lg" style="color: white; text-decoration: none; border-radius:22px;" value="Update Medicine" />
					</div>
			</div>
			</form:form>
</div>
